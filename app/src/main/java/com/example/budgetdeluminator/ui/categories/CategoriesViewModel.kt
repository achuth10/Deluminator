...
class CategoriesViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun insertCategory(category: BudgetCategory) = viewModelScope.launch {
        repository.insertCategory(category)
    }
    
    fun updateCategory(category: BudgetCategory) = viewModelScope.launch {
        repository.updateCategory(category)
    }
    
    fun deleteCategory(category: BudgetCategory) = viewModelScope.launch {
        repository.deleteCategory(category)
    }
    
    fun deleteCategoryById(id: Long) = viewModelScope.launch {
