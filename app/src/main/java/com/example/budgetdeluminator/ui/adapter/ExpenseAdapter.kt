...
class ExpenseAdapter(
    ...
    inner class ExpenseViewHolder(private val binding: ItemExpenseBinding) :
        ...
        fun bind(expense: Expense) {
            binding.apply {
                // Check if this is an auto-generated recurring expense
                val isAutoGenerated = expense.source == ExpenseSource.RECURRING

                // Use clean description (no need to remove suffix anymore)
                if (expense.description.isNotEmpty()) {
                    tvExpenseDescription.text = expense.description
                    tvExpenseDescription.visibility = View.VISIBLE
                } else {
                    tvExpenseDescription.visibility = View.GONE
                }
                ...
                // Show/hide auto-generated footer
                layoutAutoGeneratedFooter.visibility =
                        if (isAutoGenerated) {
                            View.VISIBLE
                        } else {
                            View.GONE
